...
/**
 * Created by xuwencong on 2018/11/7
 */
public class ElasticsearchTest1 {
    ...
    @Test
    public void testConnect() throws UnknownHostException {  //创建客户端
        ...
        logger.info("param1:"+client.connectedNodes());
        logger.info("param2:"+client.filteredNodes());
        logger.info("param3:"+client.listedNodes());
        logger.info("param4:"+client.transportAddresses());
        //关闭客户端
        client.close();
    }
